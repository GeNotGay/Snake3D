...
var BACKGROUND_COLOR = '#FFFFFF', BODY_COLOR = 0x388e3c, HEAD_COLOR = 0x004D40, score = 0;
...
function init(){
    ...
    for(var i = 0; i < 5; i++){
        ...
        snake.push(new Cube( new THREE.Vector3(1,1,1), snakeCubeMaterial, scene));
    }

    var appleCubeMaterial = new THREE.MeshPhongMaterial( { color: 0xc62828} );
    apple = new Cube(spawnAppleVector(), appleCubeMaterial, scene);
    var edgesMaterial = new THREE.LineBasicMaterial( { color: '#FF0000' } );
